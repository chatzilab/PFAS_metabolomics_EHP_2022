...
setwd("/project/dconti_624/Users/jagoodri/pfas_mixtures_metabolomics_sol_chs_pooled")

# Load Data
load("Pooled_mixtures_datasets_all_pfas_hyper_g_prior.Rdata")
...
# Save results
comm.write.csv(coefs,  file = "results/Pooled_mixtures_results_all_pfas_hyper_g_prior.csv")
